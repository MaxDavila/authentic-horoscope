...
// SKPolygraph
#define COCOAPODS_POD_AVAILABLE_SKPolygraph
#define COCOAPODS_VERSION_MAJOR_SKPolygraph 1
#define COCOAPODS_VERSION_MINOR_SKPolygraph 0
#define COCOAPODS_VERSION_PATCH_SKPolygraph 0
